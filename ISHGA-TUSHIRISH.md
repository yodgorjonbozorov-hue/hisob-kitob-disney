...
| `BACKUP_ENCRYPTION_KEY` | zaxira shifr kaliti (32 bayt) — **qo'yilmasa zaxira YUBORILMAYDI** (ochiq baza kanalga chiqmasligi uchun) va **kutayotgan migratsiyasi bor deploy TO'XTAYDI**. Kalitni zaxiradan alohida saqlang: yo'qolsa fayl ochilmaydi |
