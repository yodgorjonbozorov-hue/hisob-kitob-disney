...
/**
 * DATABASE_URL yo'q bo'lsa `rawPrisma` ga UMUMAN tegilmaydi: u lazy getter —
 * o'qilishining o'zi libsql clientini quradi va `URL_INVALID` bilan yiqiladi.
 * Shu sababli env'siz build butun zanjirni to'xtatib qo'yardi, garchi
 * migratsiyaning o'zi "o'tkazib yuborildi" deb chiqqan bo'lsa ham.
 * (`scripts/kassa-migratsiya.ts` dagi `ulanishniYop` bilan bir xil qoida.)
 */
