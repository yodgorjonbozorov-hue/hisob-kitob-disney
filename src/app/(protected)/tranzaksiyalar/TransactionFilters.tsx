...
export function TransactionFilters({
  ...
  return (
    <div className="bg-surface rounded-2xl shadow-sm border border-line p-4 flex flex-wrap gap-3 items-end">
      <div>
      ...
      <div className="flex-1 min-w-[160px]">
        <label className="block text-xs font-medium text-muted mb-1">Izoh bo'yicha qidirish</label>
        <input
          type="text"
          value={values.q}
