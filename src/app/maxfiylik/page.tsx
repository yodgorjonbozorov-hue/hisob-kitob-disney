...
export default function MaxfiylikPage() {
  return (
    <PublicShell>
      <div className="max-w-2xl mx-auto px-4 py-10 space-y-6 text-sm text-fg leading-relaxed">
        <h1 className="font-heading text-xl font-bold">Maxfiylik siyosati</h1>
        <p className="text-muted">Oxirgi yangilanish: 2026-yil 11-avgust</p>

        <section className="space-y-2">
          <h2 className="font-heading text-base font-semibold">Qanday ma&apos;lumot yig&apos;amiz</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="font-heading text-base font-semibold">Ma&apos;lumotlar qayerda saqlanadi</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="font-heading text-base font-semibold">Uchinchi shaxslarga berish</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="font-heading text-base font-semibold">Ma&apos;lumotni o&apos;chirish</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="font-heading text-base font-semibold">Bog&apos;lanish</h2>
          <p>
