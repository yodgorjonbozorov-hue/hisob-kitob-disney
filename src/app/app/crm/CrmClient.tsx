...
import type { BuyurtmaDTO, KategoriyaDTO, XodimDTO, XodimKategoriyaDTO } from "./turlar";
...
export function CrmClient({
  ...
  return (
    <div className="space-y-3">
      ...
      <DoskaFiltr filtr={filtr} kategoriyalar={kategoriyalar} xodimlar={xodimlar} bugun={bugun} />
