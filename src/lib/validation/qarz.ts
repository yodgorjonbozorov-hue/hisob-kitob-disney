...
/**
 * Telefon mantig'i `lib/tel.ts` ga chiqarildi — mijoz kartochkasi ham,
 * qarz ham, birlashtirish skripti ham AYNI qoidadan foydalanishi shart.
 * Bu yerda faqat qayta eksport: mavjud importlar (`@/lib/validation/qarz`)
 * o'zgarmasin.
 */
export { telNormalize, telKorinish } from "@/lib/tel";
