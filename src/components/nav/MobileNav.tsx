...
interface Props {
  ...
  omborli: boolean;
  /** Bildirishnoma badge'i — `<Suspense>` bilan oqimda keladigan server komponenti. */
 ...
 */
export default function MobileNav({ rol, businesses, activeBusinessId, notifSlot }: Props) {
  return (
    <div className="lg:hidden sticky top-0 z-40 bg-surface/90 backdrop-blur border-b border-line">
      <div className="flex items-center justify-between px-4 py-2.5 gap-2">
        <Link href="/app" aria-label="Balansa — boshqaruv paneli" className="shrink-0">
